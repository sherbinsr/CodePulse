...
import { GitBranch, BarChart3, Users, Clock } from "lucide-react";
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-8 text-center">
        <div className="max-w-3xl">
          ...
          <p className="text-slate-400 text-lg mb-10 max-w-xl mx-auto">
            Connect your GitHub organization and get instant analytics on PRs, reviews,
            developer performance, and team velocity.
          </p>
          <button
            onClick={handleLogin}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-20 max-w-3xl w-full">
          {[
            ...
            <div key={label} className="bg-slate-800/50 border border-slate-700 rounded-xl p-5 text-left">
