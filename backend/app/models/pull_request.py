...
class PullRequest(Base):
    ...
    base_branch: Mapped[Optional[str]] = mapped_column(String(255))
    action_file: Mapped[Optional[str]] = mapped_column(String(255))
    action_status: Mapped[Optional[str]] = mapped_column(String(50))
    action_name: Mapped[Optional[str]] = mapped_column(String(255))
    action_file_content: Mapped[Optional[str]] = mapped_column(Text)
